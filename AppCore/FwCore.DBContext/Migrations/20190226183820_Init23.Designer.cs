...
namespace FwCore.DBContext.Migrations
{
    ...
    [Migration("20190226183820_Init23")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FwCore.DBContext.Model.TenderFile", b =>
                {
            ...
            modelBuilder.Entity("FwCore.DBContext.Model.TenderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("TGoodsName")
                        .IsRequired();
            ...
            modelBuilder.Entity("FwCore.DBContext.Submits.NewGood", b =>
                {
                    b.Property<int>("GoodsId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FwCore.DBContext.Submits.SubmitGood", b =>
                {
                    b.Property<int>("SubmitId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FwCore.DBContext.Submits.NewGood", b =>
                {
                    b.HasOne("FwCore.DBContext.Submits.SubmitGood", "Submit")
                        .WithMany("Goods")
                        .HasForeignKey("SubmitId");
                });
