...
namespace FwCore.DBContext.Migrations
{
    ...
    [Migration("20190224093622_Init11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FwCore.DBContext.Model.TenderProdudct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("TendersTenderID");

                    b.HasKey("Id");

                    b.HasIndex("TendersTenderID");

                    b.ToTable("tenderProdudcts");
                });
            ...
            modelBuilder.Entity("FwCore.DBContext.Model.TenderProdudct", b =>
                {
                    b.HasOne("FwCore.DBContext.Model.Tenders")
                        .WithMany("TenderProdudcts")
